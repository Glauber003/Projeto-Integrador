                        ...
                        <div class="card card-hidden" style="position: fixed; min-height: 480px; width: 360px; margin-top: 10px; padding-bottom: 10px;">
                            <div class="header text-center"><img src="img/logo.png" /></div>
                                ...
                                <div class="content">
                                    ...
                                    <div class="form-group">
                                        <label>Nome</label>
                                        <input type="text" name="nome_usuario" placeholder="Informe seu nome" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>CPF</label>
                                        <input type="text" name="cpf" placeholder="Informe seu usuário" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>RG</label>
                                        <input type="password" name="rg" placeholder="Informe sua senha" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" name="email" placeholder="Informe sua senha" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Senha</label>
                                    ...
                                    <div class="form-group">
                                        <label>Sexo</label>
                                        <input type="text" name="sexo" placeholder="Informe sua senha" class="form-control">
                                            
                                    </div>
                                    <div class="form-group">
                                        <label>Nacionalidade</label>
                                        <input type="text" name="nacionalidade" placeholder="Informe sua senha" class="form-control">
