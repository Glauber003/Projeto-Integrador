...
-o-background-size: cover; /* OPERA */">
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/cadastrodeanimal.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="<?= base_url('enviarloginapicadastro') ?>" method="post">
				...
				<div class="wrap-input100 validate-input m-b-23" data-validate="É necessário inserir seu login!">
					...
					<input class="input100" type="text" name="nome_animal" placeholder="Digite o nome do seu animalzinho">
					<span class="focus-input100" data-symbol="&#xf206;"></span>
				</div>

        <div class="wrap-input100 validate-input m-b-23" data-validate="É necessário inserir seu login!">
					<span class="label-input100">Espécie do animal</span>
					<input class="input100" type="text" name="especie_animal" placeholder="Digite a especié do seu animalzinho">
					<span class="focus-input100" data-symbol="&#xf206;"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="É necessário inserir seu CPF!">
					<span class="label-input100">Idade do animal</span>
					<input class="input100" type="text" name="idade" placeholder="Digite a idade dele">
					<span class="focus-input100" data-symbol="&#xf206;"></span>
				</div>

				<br>
				<div class="wrap-input100 validate-input" data-validate="É necessário inserir seu RG!">
					<span class="label-input100">Descrição do pet</span>
					<input class="input100" type="text" name="descricao_animal" placeholder="Fale um pouco sobre ele , ex: docil ">
					<span class="focus-input100" data-symbol="&#xf206;"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="É necessário inserir uma senha!">
					<span class="label-input100">Raça do animal</span>
					<input class="input100" type="text" name="raca" placeholder="Digite aqui a raça do seu animal">
					<span class="focus-input100" data-symbol="&#xf190;"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="É necessário inserir sua nacionalidade">
					<span class="label-input100">Local do animal</span>
					<input class="input100" type="text" name="local_animal" placeholder="Descreva um pouco onde o animal esta">
					<span class="focus-input100" data-symbol="&#xf206;"></span>
				</div>
