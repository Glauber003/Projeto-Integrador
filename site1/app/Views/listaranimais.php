...
<div class="card" style="width: 40rem; display: flex">
  <div class="card-body">
    <h5 style="width: 500px; padding: 60px; font-size: 80px" class="card-title">Título do card</h5>
    <?php foreach($listaranimais as $listaranimaiss) : ?>
      <div class="box">
        ...
        <div style="line-height: 3rem; white-space: nowrap" class="content">
          <p style="width: 500px; padding: 40px; font-size: 50px;"  class="card-text">-ID Animal :       <?php echo $listaranimaiss ['id_animal']?></p>
          <p style="width: 500px; padding: 40px; font-size: 50px;"  class="card-text">-Nome do Animal:   <?php echo $listaranimaiss ['nome_animal']?></p>
          <p style="width: 500px; padding: 40px; font-size: 50px;"  class="card-text">-Espécie:          <?php echo $listaranimaiss ['especie_animal']?></p>
          <p style="width: 500px; padding: 40px; font-size: 50px;"  class="card-text">-Raça:             <?php echo $listaranimaiss ['raca']?></p>
          <p style="width: 500px; padding: 40px; font-size: 50px;"  class="card-text">-Porte:            <?php echo $listaranimaiss ['porte']?></p>
          <p style="width: 500px; padding: 40px; font-size: 50px;"  class="card-text">-Sexo:             <?php echo $listaranimaiss ['sexo']?></p>
          <p style="width: 500px; padding: 40px; font-size: 50px;"  class="card-text">-Idade:            <?php echo $listaranimaiss ['idade']?></p>
          <p style="width: 500px; padding: 40px; font-size: 50px;"  class="card-text">-Local:            <?php echo $listaranimaiss ['local_animal']?></p>
          <p style="width: 500px; padding: 40px; font-size: 50px;"  class="card-text">-Descrição Do Pet: <?php echo $listaranimaiss ['descricao_pet']?></p>
          <a style="width: 500px; padding: 40px; font-size: 50px;"  href="#" class="btn btn-primary">Visitar</a>
        </div>
      </div>
    <?php endforeach;?>
  </div>
