...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.1.3/css/bootstrap.min.css" integrity="sha512-LOb8l0tvm5ETD3kdj5/5yrjFkctnZJLR2Z+dpX9xjxNcucyHLSmYfjGIF32wC2eHrZrA7kMkIgjWx/j8tB0+5g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<a href="#" class="btn btn-warning">SEJA BEM VINDO <?php echo $user_data['nome']; ?>!</a>
...
<section class="hero">
  <div class="hero-left">
    <h1 class="hero__h2">
      ...
      Este é um ótimo espaço para escrever um texto longo sobre a sua compania e seus serviços. 
      </br></br>
      Você pode usar esse espaço para entrar em detalhes sobre a sua empresa. Fale sobre a sua equipe e sobre os serviços prestados por você.
...
<section class="hero">
  <div class="hero-left">
    <h1 class="hero__h2">
      <li>
        <span list-style-tipe="circle" class="hero__h1--color">Voluntáriado</span>
      </li>
      <p class="hero__text4">
      Segundo informações do instituto bilubilubilu Sou um parágrafo. Clique aqui para editar-me e adicionar o seu próprio texto. É fácil! Basta clicar em "Editar Texto" ou clicar duas vezes sobre mim e você poderá adicionar o seu próprio conteúdo e trocar fontes. 
      </br></br>
  ...
  <h1 class="hero__h2">
    <div class="container">
      <div class="row">
        ...
        <img style="width: 100%" src="images/voluntario_inicio2.png">
        <img style="width: 100%" src="images/voluntario_inicio.jpg">
        </div>
      </div>
    </div>
  </h1> 
...
<footer>
  ...
  <div class="boxs">
    <h2 style="font-size:40px">Contatos</h2><!DOCTYPE html>
<!-- saved from url=(0044)https://paulopbi.github.io/pequenos-amigos/# -->
<html lang="pt-br"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
